...
class CharacterControllerDemo {
  ...
  _Initialize() {
    ...
    this._camera.position.set(120, 35, -60); //70 for mirror
...
[
  new THREE.MeshBasicMaterial ({map: new THREE.TextureLoader().load('images/oldwood.jpg'), side: THREE.DoubleSide}),
  new THREE.MeshBasicMaterial ({map: new THREE.TextureLoader().load('images/oldwood.jpg'), side: THREE.DoubleSide}),
  new THREE.MeshBasicMaterial ({map: new THREE.TextureLoader().load('images/oldwood.jpg'), side: THREE.DoubleSide}),
  new THREE.MeshBasicMaterial ({map: new THREE.TextureLoader().load('images/oldwood.jpg'), side: THREE.DoubleSide}),
  new THREE.MeshBasicMaterial ({map: new THREE.TextureLoader().load('images/oldwood.jpg'), side: THREE.DoubleSide}),
...
let ahousedoor1Materials = new THREE.MeshLambertMaterial({map: new THREE.TextureLoader().load('images/oldwood.jpg'), side: THREE.DoubleSide});
...
pigmouth2Cube.position.x=20
pigmouth2Cube.position.y=8
pigmouth2Cube.position.z=106
